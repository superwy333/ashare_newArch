...
@Table(name = "accounting_section")
public class AccountingSection extends BaseDomain {
    /**
     * 全宗号
     */
     ...
     * 凭证数量
     */
    @Column(name = "attachment_sum")
    private Integer attachmentSum;

    /**
     * 分册人编码
     */
    @Column(name = "filing_person_id")
    private String filingPersonId;

    /**
     * 分册人名称
     */
    @Column(name = "filing_person_name")
     ...
     * 归档人编码
     */
    @Column(name = "filed_person_id")
    private String filedPersonId;

    /**
     * 归档人名称
     */
    @Column(name = "filed_person_name")
     ...
     * 密级
     */
    @Column(name = "file_secret_level")
    private String fileSecretLevel;

    /**
     * 保管期限
     */
    @Column(name = "file_storage_period")
