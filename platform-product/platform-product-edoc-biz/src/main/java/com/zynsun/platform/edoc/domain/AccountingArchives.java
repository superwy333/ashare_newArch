...
@Table(name = "accounting_archives")
public class AccountingArchives extends BaseDomain {
    /**
     * 档号
     */
     ...
     * 报账提交人/经办人编码
     */
    @Column(name = "expense_person_code")
    private String expensePersonCode;

    /**
     * 报账提交人/经办人姓名
     */
    @Column(name = "expense_person_name")
