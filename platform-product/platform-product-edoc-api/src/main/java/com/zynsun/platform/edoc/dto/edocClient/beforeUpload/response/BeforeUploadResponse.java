...
public class BeforeUploadResponse extends AbstractResponse implements Serializable {
    ...
    private BeforeUploadResponseBody body;
    ...
    public BeforeUploadResponseBody getBody() {
        return body;
    }

    public void setBody(BeforeUploadResponseBody body) {
        this.body = body;
    }
