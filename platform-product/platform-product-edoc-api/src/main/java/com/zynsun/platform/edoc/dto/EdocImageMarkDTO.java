 ...
 **/
public class EdocImageMarkDTO extends PageDTO {
    ...
    private List<EdocImageMarkDetailsDTO> markList = new ArrayList<>();

    public List<EdocImageMarkDetailsDTO> getMarkList() {
        return markList;
    }

    public void setMarkList(List<EdocImageMarkDetailsDTO> markList) {
