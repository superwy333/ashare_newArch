...
public class InvoiceDTO extends PageDTO {
    ...
    public enum RedOrBlueEnum implements BaseEnum {
        redOrBlue1("1"),redOrBlue2("2");

        private final String code;

        RedOrBlueEnum(String code)
        {
            this.code = code;
        }
        ...
        public static RedOrBlueEnum parse(String code) {
            RedOrBlueEnum result = null; // Default
            for (RedOrBlueEnum item : RedOrBlueEnum.values()) {
    ...
    public enum InvTypeEnum implements BaseEnum{
        invoiceType1("1"),invoiceType2("2"),invoiceType4("4");

        private final String code;

        InvTypeEnum(String code)
        {
            this.code = code;
        }
        ...
        public static InvTypeEnum parse(String code) {
    ...
    public enum InvCheckRealEnum implements BaseEnum{
        checkReal1("1"),checkReal2("2");

        private final String code;

        InvCheckRealEnum(String code)
        {
            this.code = code;
        }
        ...
        public static InvCheckRealEnum parse(String code) {
            InvCheckRealEnum result = null; // Default
            for (InvCheckRealEnum item : InvCheckRealEnum.values()) {
                if (BeanUtil.equals(item.getCode(),code)) {
                    result = item;
                    break;
                }
    ...
    public enum InvCheckDetailsEnum implements BaseEnum{
        checkDetails11("11"),checkDetails12("12"),checkDetails13("13");

        private final String code;

        InvCheckDetailsEnum(String code)
        {
            this.code = code;
        }
        ...
        public static InvCheckDetailsEnum parse(String code) {
            InvCheckDetailsEnum result = null; // Default
            for (InvCheckDetailsEnum item : InvCheckDetailsEnum.values()) {
                if (BeanUtil.equals(item.getCode(),code)) {
                    result = item;
                    break;
                }
    ...
    public enum InvSourceEnum implements BaseEnum{
        invSource1("1"),invSource2("2"),invSource3("3");

        private final String code;

        InvSourceEnum(String code)
        {
            this.code = code;
        }
        ...
        public static InvSourceEnum parse(String code) {
            InvSourceEnum result = null; // Default
            for (InvSourceEnum item : InvSourceEnum.values()) {
                if (BeanUtil.equals(item.getCode(),code)) {
                    result = item;
                    break;
                }
    ...
    public enum InvoiceCheckStatusEnum implements BaseEnum{
        invCheckStatus01("01"),
        invCheckStatus11("11"),
        invCheckStatus12("12"),
        invCheckStatus13("13");
        ...
        InvoiceCheckStatusEnum(String code)
        {
            this.code = code;
        }
        ...
        public static InvoiceCheckStatusEnum parse(String code) {
            InvoiceCheckStatusEnum result = null; // Default
            for (InvoiceCheckStatusEnum item : InvoiceCheckStatusEnum.values()) {
                if (BeanUtil.equals(item.getCode(),code)) {
                    result = item;
                    break;
                }
