package com.zynsun.platform.dubbo;
...
public class EdocAppServer {
    private final static Logger logger = LoggerFactory.getLogger(EdocAppServer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 初始化本地日志输出目录
        confDir = new File(Thread.currentThread().getContextClassLoader()
                .getResource("").getPath());
     ...
     * @throws IOException
     */
    private static void addShutdownHook(ClassPathXmlApplicationContext context)
            throws Exception {
