...
#JDK所在路径
#JAVA_HOME=/usr/local/soft/jdk/jdk1.8.0_131
...
#应用名
APP_NAME=platform-product-edoc-api-impl
...
APP_MAINCLASS=com.zynsun.platform.dubbo.EdocAppServer
