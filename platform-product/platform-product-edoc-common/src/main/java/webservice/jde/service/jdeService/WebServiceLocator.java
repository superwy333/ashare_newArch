...
public class WebServiceLocator extends org.apache.axis.client.Service implements webservice.jde.service.jdeService.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://192.168.1.146:8090/NewHope/WebService.asmx";
    ...
    public webservice.jde.service.jdeService.WebServiceSoap_PortType getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.jde.service.jdeService.WebServiceSoap_BindingStub _stub = new webservice.jde.service.jdeService.WebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.jde.service.jdeService.WebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.jde.service.jdeService.WebServiceSoap_BindingStub _stub = new webservice.jde.service.jdeService.WebServiceSoap_BindingStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
