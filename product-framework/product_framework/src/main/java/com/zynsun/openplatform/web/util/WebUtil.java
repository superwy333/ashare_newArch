package com.zynsun.openplatform.web.util;
...
public final class WebUtil {
     ...
     * @param @param request
     * @param @param cookieName cookie名字
    ...
    public static final Long getCurrentUser() {
        ...
        if (null != currentUser) {
            ...
            if (null != session) {
                return (Long) session.getAttribute(WebConstants.CURRENT_USER);
            }
        }
        return null;
    }
     ...
     * @Description: 获得HttpServletRequest参数Map 
     * @param @param request
     * @param @return 
